		...
		var displayTrailer = (vid) => {
			return (
				<div>
					...
					{modalOpen ? displayModal(vid) : null}
				</div>
			);
		};
							...
							<div className="modal-body px-8 py-8">
								...
								>
									<iframe
										...
										src={"https://www.youtube.com/embed/" + des.results[0].key}
										style={{ border: 0 }}
		...
		return (
			<div>
				<div className="movie-info border-b border-gray-800">
					<div className="container mx-auto px-4 py-16 flex flex-col md:flex-row">
						...
						<div className="md:ml-24">
							...
							{type === "movie" ? crew(credits.crew) : creator(created_by)}
				...
				<div className="container mx-auto px-4 py-16">
					...
					{imgModal ? showImgModal(chImg) : null}
				</div>
				{/* </div> */}
				{/* {{-- end of images --}} */}
			</div>
